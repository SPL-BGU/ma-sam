...
from experiments.experiments_consts import MAX_SIZE_MB, DEFAULT_SPLIT, DEFAULT_NUMERIC_TOLERANCE
...
class ParallelExperimentRunner:
    ...
    def _export_learned_domain(self, learned_domain: LearnerDomain, test_set_path: Path,
    ...
    def _export_domain_and_backup(self, allowed_observations, fold_number, learned_model, negative_preconditions_policy,
